...
module.exports=require('fS8pZb');
},{}],"fS8pZb":[function(require,module,exports){
...
},{"backbone":"QPRzXk","jquery":"XihgF+","underscore":"YX++l6"}],"backbone":[function(require,module,exports){
module.exports=require('QPRzXk');
},{}],"QPRzXk":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
...
},{"underscore":"YX++l6"}],"XihgF+":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
/*!
...
module.exports=require('XihgF+');
},{}],"underscore":[function(require,module,exports){
module.exports=require('YX++l6');
},{}],"YX++l6":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
//     Underscore.js 1.5.2
...
},{"./collections/contacts":2,"./collections/messages":3,"./controller":4,"./models/contact":6,"./router":8}],2:[function(require,module,exports){
...
},{"../models/message":7}],4:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
    ContactsView = require('./views/contacts'),
    ContactDetailsView = require('./views/contact_details'),
    AddContactView = require('./views/add'),
    MessageAllView = require('./views/message_all');
...
module.exports = Controller = Marionette.Controller.extend({
    ...
    message: function() {
        App.core.vent.trigger('app:log', 'Controller: "Send Message" route hit.');
        var view = new MessageAllView();
        this.renderView(view);
        window.App.router.navigate('message');
    },
...
},{"./views/add":9,"./views/contact_details":10,"./views/contacts":11,"./views/message_all":12}],5:[function(require,module,exports){
var App = require('./app');
var myapp = new App();
myapp.start();
...
},{"../../templates/message_all.hbs":16}],13:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  if (stack1 = helpers.nameFirst) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.nameFirst; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + " ";
  if (stack1 = helpers.nameLast) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.nameLast; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "<br/>\r\n    <strong>Email:</strong> ";
  ...
  if (stack1 = helpers.carrier) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.carrier; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "<br/><br/>\r\n\r\n</div>\r\n<button type=\"submit\" class=\"btn btn-default button-back\">Back</button>\r\n<button type=\"submit\" class=\"btn btn-default button-delete\">Delete Contact</button>\r\n";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"contact_small bg-info img-rounded\">\r\n    <strong>";
  if (stack1 = helpers.nameFirst) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.nameFirst; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + " ";
...
},{"handlebars/lib/handlebars/base":17,"handlebars/lib/handlebars/runtime":18,"handlebars/lib/handlebars/utils":19}]},{},[5])
;